...
import SingUpPic from "../assets/img/signUp.png";
  ...
  return (
    <div className="flex justify-between h-screen items-center w-full">
      ...
      <div className="w-full">
        <form
          action=""
          className="flex-col gap-2 flex rounded-lg p-5 shadow-lg w-[70%] mx-auto "
        >
          {/* email */}
          <div className="flex flex-col gap-2">
            <label htmlFor="" className="text-lg font-semibold tracking-wide">
              Email
            </label>
            <input
              type="email"
              className="outline-none rounded-lg border p-2"
          ...
          <div className="flex justify-around mt-5 text-sm text-gray-400">
            ...
            <Link to={"/login"}>
              <h3 className="text-blue-400 underline cursor-pointer">
                LogIn Here
              </h3>
            </Link>
          </div>
          ...
          <div className="mt-5 shadow-lg mx-auto">
            <button className="text-lg font-semibold cursor-pointer bg-blue-600 rounded tracking-wide text-white px-5 py-1 hover:scale-125 duration-200 ">
              Register
            </button>
          </div>
        </form>
